...
import "./index.css";
const VideoReview = ({ onFinish }) => {
    const [rating, setRating] = useState(0);

    return (
        <div className="review-card">
            <h3>Material Review - Video</h3>
...
const LearningVideo = () => {
    ...
    return (
        <div className="container mt-5">
            {!completed ? (
                <div className="video-player-section text-center">
                    <h2>Python for Beginners - Variables and Types</h2>
                    <div className="ratio ratio-16x9 my-4 shadow rounded overflow-hidden">
                        <iframe src="about:blank" title="Empty Frame" allowFullScreen={true}></iframe>
                    </div>
                    <button
                ...
                <div className="fade-in">
                    <VideoReview onFinish={() => alert("Thank you for your feedback!")} />
                </div>
            )}
        </div>
    );
